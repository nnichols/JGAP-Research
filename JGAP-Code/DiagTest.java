/*
 * Nick Nichols - DiagTest.java
 *
 * This class will test the functionality of the Diagonalization Operator
 *
 */
...
public class DiagTest{
	public static void main( String[] args ) throws Exception{
		...
		int diagCheck = Integer.parseInt( args[0] );
		...
		try{
			...
			// Add our diagonalization operator as the only operator
