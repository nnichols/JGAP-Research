 ...
 * Files are loacted at Test-Cases/tsp%nc%me where %n = cities, %m = edges
...
public class TSPGenerator{
	public static void main( String[] args ){
		...
		try{
			...
			BufferedWriter outStream = new BufferedWriter( new FileWriter( "./Test-Cases/tsp" + cityCount + "c" + instance.getEdges() + "e.txt" ));
