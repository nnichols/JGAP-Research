...
With a small extension, this algorithm allows us to deal with genetic sequemces based off of genetic overlays in a similar matter. We need only skip over the values in the genetic overlay, and use the pre-exsisting algorithm for the undefined portions of the overlay. The extended permutation repair algorithm is fully defined in Figure-\ref{PRA-Alg}. 
